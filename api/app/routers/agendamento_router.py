...
@router.get("/agendamento/{agendamento_id}", response_model=schemas.Agendamento)
...
@router.put("/agendamento/{agendamento_id}", response_model=schemas.Agendamento)
...
@router.delete("/agendamento/{agendamento_id}", response_model=schemas.Agendamento)
